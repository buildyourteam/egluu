...
export function usePeopleListState(data, fulfilled, pending, rejected, error, getApi) {
...
export function usePeopleSaveEffect(data, fulfilled, pending, rejected, error, posApi) {
