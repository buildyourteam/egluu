...
const ProjectPage = () => {
    ...
    const [{projectState, navState}, setProjectState, setNavState] = useProjectData();
    ...
    return (
        <div>
            ...
            <FormControl className={classes.formcontrol}>
                <InputLabel shrink={false} id="jobGroupLabel">{navState.jobGroup === '' ? '직군' : ''}</InputLabel>
                <Select
                    className={classes.select}
            ...
            <FormControl className={classes.formcontrol}>
                <InputLabel shrink={false} id="areaLabel">{navState.area === '' ? '지역' : ''}</InputLabel>
                <Select
                    className={classes.select}
                    labelId="areaLabel"
                    id="area"
            ...
            <div>
                {projectState.length}개의 팀이 있습니다.
            </div>
            <Grid container>
