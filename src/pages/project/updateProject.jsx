                ...
                <div>로딩중...</div>
                    ...
                    <div>
                        ...
                        <InputGroup>
                            ...
                            <Input placeholder="프로젝트 설명" name="introduction" onChange={projectAction.inputProject} value={project.project.introduction} />
                        </InputGroup>
                        <InputGroup>
                            <InputGroupAddon addonType="prepend">
                        ...
                        {project.project.questions.map((value, index) => (
                            <InputGroup>
                                ...
                                <InputGroupAddon addonType="append">
                                    <Button color="secondary" onClick={() => projectAction.deleteQuestion(index)}>삭제</Button>
                                </InputGroupAddon>
                            </InputGroup>
                        ))}
